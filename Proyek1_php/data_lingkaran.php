        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="data_persegi_panjang.php">Class Persegi Panjang</a></li>
              <li class="breadcrumb-item active">Class Lingkaran</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
?>
              ...
              <div class="card-footer">
                <b><a href="data_persegi_panjang.php">Class Persegi Panjang</a> KLIK DISINI</b>
              </div>
              <!-- /.card-footer-->
            </div>
            <!-- /.card -->
